...
# start button
start_btn = tkinter.Button(text="Start", highlightthickness=0, command=start_time)
start_btn.grid(column=0, row=2)


# reset button
reset_btn = tkinter.Button(text="Reset", highlightthickness=0, command=reset_time)
